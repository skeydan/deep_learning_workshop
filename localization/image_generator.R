...
# if the net has a single output, returns a list of (x,y) where
# y consists of vectors [class_code, xmin, xmax, ymin, ymax]
# if the net has two outputs, returns a list(x, list(y1,y2)) where
# y1 comprises the class codes and y2 consists of vectors [xmin, xmax, ymin, ymax]
